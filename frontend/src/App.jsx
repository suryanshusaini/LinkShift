...
function App() {
  ...
  // Lifted so logout can atomically clear it — prevents session-flash on re-login
          ...
          <div>
            ...
            <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 border-b border-slate-200 shadow-sm">
              <div className="flex justify-between items-center px-6 py-4 max-w-6xl mx-auto">
                <Link
                  to="/"
                  className="flex items-center gap-2 text-2xl font-extrabold tracking-tight text-slate-900 transition-all duration-300 ease-in-out hover:scale-[1.02]"
                >
                  {/* Clean chain/link SVG icon — Heroicons "link" outline */}
                ...
                <div>
                  {user ? (
                    <div className="flex items-center space-x-6">
                      ...
                      <Link
                        to="/dashboard"
                        className="text-sm font-semibold text-slate-600 hover:text-slate-900 transition-all duration-300 ease-in-out"
                      >
                        My Links
                      </Link>
                      <button
                        onClick={handleLogout}
                        className="text-sm font-semibold text-red-500 hover:text-red-700 transition-all duration-300 ease-in-out bg-red-50 hover:bg-red-100 px-4 py-2 rounded-lg"
                      >
                        Log out
                      </button>
                    </div>
                    ...
                    <div className="space-x-3">
                      <Link
                        to="/login"
                        className="px-5 py-2.5 text-sm font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all duration-300 ease-in-out"
                      >
                        Log in
                      </Link>
                      <Link
                        to="/signup"
                        className="px-5 py-2.5 text-sm font-semibold bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all duration-300 ease-in-out shadow-md hover:shadow-lg"
                      >
                        Sign up
                      </Link>
                    </div>
